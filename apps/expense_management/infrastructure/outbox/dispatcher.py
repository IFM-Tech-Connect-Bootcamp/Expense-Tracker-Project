"""Outbox event dispatcher for processing and delivering events in Expense Management.
...
class OutboxDispatcher:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'processed_events': OutboxEvent.objects.filter(processed_at__isnull=True).count(),
