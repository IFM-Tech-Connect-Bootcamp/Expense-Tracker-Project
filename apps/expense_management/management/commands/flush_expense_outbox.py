"""Django management command wrapper for expense management outbox processing.
...
from apps.expense_management.infrastructure.management.commands.flush_expense_outbox import Command as InfraCommand
