"""Django management command wrapper for expense management infrastructure health checks.
...
from apps.expense_management.infrastructure.management.commands.check_infrastructure import Command as InfraCommand
